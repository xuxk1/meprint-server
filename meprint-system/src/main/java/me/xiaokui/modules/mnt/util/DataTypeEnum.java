...
package me.xiaokui.modules.mnt.util;
...
public enum DataTypeEnum {
    ...
    /** mysql */
    MYSQL("mysql", "mysql", "me.mysql.jdbc.Driver", "`", "`", "'", "'"),

    /** oracle */
    ORACLE("oracle", "oracle", "oracle.jdbc.driver.OracleDriver", "\"", "\"", "\"", "\""),

    /** sql server */
    SQLSERVER("sqlserver", "sqlserver", "me.microsoft.sqlserver.jdbc.SQLServerDriver", "\"", "\"", "\"", "\""),
    ...
    /** presto */
    PRESTO("presto", "presto", "me.facebook.presto.jdbc.PrestoDriver", "", "", "\"", "\""),

    /** moonbox */
    MOONBOX("moonbox", "moonbox", "moonbox.jdbc.MbDriver", "`", "`", "`", "`"),

    /** cassandra */
    CASSANDRA("cassandra", "cassandra", "me.github.adejanovski.cassandra.jdbc.CassandraDriver", "", "", "'", "'"),
    ...
    /** vertica */
    VERTICA("vertica", "vertica", "me.vertica.jdbc.Driver", "", "", "'", "'"),

    /** sap */
    HANA("sap", "sap hana", "me.sap.db.jdbc.Driver", "", "", "'", "'"),

    /** impala */
    IMPALA("impala", "impala", "me.cloudera.impala.jdbc41.Driver", "", "", "'", "'");
