 ...
 */
package me.xiaokui.modules.mnt.service.impl;

import cn.hutool.core.date.DatePattern;
import cn.hutool.core.date.DateUtil;
import lombok.RequiredArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import me.xiaokui.modules.mnt.domain.App;
import me.xiaokui.modules.mnt.domain.Deploy;
import me.xiaokui.modules.mnt.domain.DeployHistory;
import me.xiaokui.modules.mnt.domain.ServerDeploy;
import me.xiaokui.modules.mnt.service.DeployHistoryService;
import me.xiaokui.modules.mnt.service.DeployService;
import me.xiaokui.modules.mnt.service.ServerDeployService;
import me.xiaokui.modules.mnt.service.dto.AppDto;
import me.xiaokui.modules.mnt.service.dto.DeployDto;
import me.xiaokui.modules.mnt.service.dto.DeployQueryCriteria;
import me.xiaokui.modules.mnt.service.dto.ServerDeployDto;
import me.xiaokui.modules.mnt.util.ExecuteShellUtil;
import me.xiaokui.modules.mnt.util.ScpClientUtil;
import me.xiaokui.exception.BadRequestException;
import me.xiaokui.modules.mnt.domain.App;
import me.xiaokui.modules.mnt.domain.Deploy;
import me.xiaokui.modules.mnt.domain.DeployHistory;
import me.xiaokui.modules.mnt.domain.ServerDeploy;
import me.xiaokui.modules.mnt.repository.DeployRepository;
import me.xiaokui.modules.mnt.service.DeployHistoryService;
import me.xiaokui.modules.mnt.service.DeployService;
import me.xiaokui.modules.mnt.service.ServerDeployService;
import me.xiaokui.modules.mnt.service.dto.AppDto;
...
import me.xiaokui.modules.mnt.service.dto.DeployQueryCriteria;
import me.xiaokui.modules.mnt.service.dto.ServerDeployDto;
import me.xiaokui.modules.mnt.service.mapstruct.DeployMapper;
import me.xiaokui.modules.mnt.util.ExecuteShellUtil;
import me.xiaokui.modules.mnt.util.ScpClientUtil;
import me.xiaokui.modules.mnt.websocket.MsgType;
import me.xiaokui.modules.mnt.websocket.SocketMsg;
import me.xiaokui.modules.mnt.websocket.WebSocketServer;
...
public class DeployServiceImpl implements DeployService {
	...
	public Object queryAll(DeployQueryCriteria criteria, Pageable pageable) {
		Page<Deploy> page = deployRepository.findAll((root, criteriaQuery, criteriaBuilder) -> me.xiaokui.utils.QueryHelp.getPredicate(root, criteria, criteriaBuilder), pageable);
		return me.xiaokui.utils.PageUtil.toPage(page.map(deployMapper::toDto));
	}
	...
	public DeployDto findById(Long id) {
		...
		me.xiaokui.utils.ValidationUtil.isNull(deploy.getId(), "Deploy", "id", id);
	...
	public void update(Deploy resources) {
		...
		me.xiaokui.utils.ValidationUtil.isNull(deploy.getId(), "Deploy", "id", resources.getId());
	...
	private void backupApp(ExecuteShellUtil executeShellUtil, String ip, String fileSavePath, String appName, String backupPath, Long id) {
		...
		deployHistory.setDeployUser(me.xiaokui.utils.SecurityUtils.getCurrentUsername());
