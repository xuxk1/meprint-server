...
import me.xiaokui.modules.system.service.MonitorService;
import me.xiaokui.utils.ElAdminConstant;
...
public class MonitorServiceImpl implements MonitorService {
    ...
    private Map<String,Object> getDiskInfo(OperatingSystem os) {
        ...
        diskInfo.put("total", total > 0 ? me.xiaokui.utils.FileUtil.getSize(total) : "?");
        diskInfo.put("available", me.xiaokui.utils.FileUtil.getSize(available));
