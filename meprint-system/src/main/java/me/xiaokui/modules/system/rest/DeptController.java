...
public class DeptController {
    ...
    public ResponseEntity<Object> update(@Validated(BaseEntity.Update.class) @RequestBody Dept resources){
    ...
    public ResponseEntity<Object> delete(@NotNull @RequestBody Set<Long> ids){
