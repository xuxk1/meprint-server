...
import me.xiaokui.modules.system.domain.Menu;
import me.xiaokui.modules.system.domain.Role;
import me.xiaokui.modules.system.domain.User;
import me.xiaokui.modules.system.domain.vo.MenuMetaVo;
import me.xiaokui.modules.system.domain.vo.MenuVo;
import me.xiaokui.modules.system.service.MenuService;
import me.xiaokui.modules.system.service.RoleService;
import me.xiaokui.modules.system.service.dto.MenuDto;
import me.xiaokui.modules.system.service.dto.MenuQueryCriteria;
...
public class MenuServiceImpl implements MenuService {
    ...
    public MenuDto findById(long id) {
        ...
        me.xiaokui.utils.ValidationUtil.isNull(menu.getId(),"Menu","id",id);
    ...
    public void create(Menu resources) {
        if(menuRepository.findByTitle(resources.getTitle()) != null){
            throw new me.xiaokui.exception.EntityExistException(Menu.class,"title",resources.getTitle());
        }
        if(me.xiaokui.utils.StringUtils.isNotBlank(resources.getComponentName())){
            if(menuRepository.findByComponentName(resources.getComponentName()) != null){
                throw new me.xiaokui.exception.EntityExistException(Menu.class,"componentName",resources.getComponentName());
            }
        }
        ...
        if(resources.getIFrame()){
            ...
            if (!(resources.getPath().toLowerCase().startsWith(http)||resources.getPath().toLowerCase().startsWith(https))) {
                throw new me.xiaokui.exception.BadRequestException("外链必须以http://或者https://开头");
            }
        }
    ...
    public void update(Menu resources) {
        ...
        me.xiaokui.utils.ValidationUtil.isNull(menu.getId(),"Permission","id",resources.getId());
        ...
        menuDtos.forEach(menuDTO -> {
                    if (menuDTO!=null){
                        ...
                        if(!menuDTO.getIFrame()){
                            if(menuDTO.getPid() == null){
                                menuVo.setComponent(me.xiaokui.utils.StringUtils.isEmpty(menuDTO.getComponent())?"Layout":menuDTO.getComponent());
                                // 如果不是一级菜单，并且菜单类型为目录，则代表是多级菜单
                            }else if(menuDTO.getType() == 0){
                                menuVo.setComponent(me.xiaokui.utils.StringUtils.isEmpty(menuDTO.getComponent())?"ParentView":menuDTO.getComponent());
                            }else if(me.xiaokui.utils.StringUtils.isNoneBlank(menuDTO.getComponent())){
