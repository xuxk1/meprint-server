...
public class DictServiceImpl implements DictService {
    ...
    public List<DictDto> queryAll(DictQueryCriteria dict) {
        List<Dict> list = dictRepository.findAll((root, query, cb) -> me.xiaokui.utils.QueryHelp.getPredicate(root, dict, cb));
    ...
    public void update(Dict resources) {
        ...
        me.xiaokui.utils.ValidationUtil.isNull( dict.getId(),"Dict","id",resources.getId());
