...
public class RoleController {
    ...
    @me.xiaokui.annotation.Log("新增角色")
    @ApiOperation("新增角色")
    @PostMapping
    @PreAuthorize("@el.check('roles:add')")
    public ResponseEntity<Object> create(@Validated @RequestBody Role resources){
        if (resources.getId() != null) {
            throw new me.xiaokui.exception.BadRequestException("A new "+ ENTITY_NAME +" cannot already have an ID");
        }
    ...
    @me.xiaokui.annotation.Log("修改角色")
    @ApiOperation("修改角色")
    @PutMapping
    ...
    @me.xiaokui.annotation.Log("修改角色菜单")
    @ApiOperation("修改角色菜单")
