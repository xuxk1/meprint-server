 ...
 */
package me.xiaokui.modules.quartz.service.impl;
...
import me.xiaokui.modules.quartz.utils.QuartzManage;
import me.xiaokui.utils.FileUtil;
import me.xiaokui.modules.quartz.domain.QuartzJob;
import me.xiaokui.modules.quartz.domain.QuartzLog;
import me.xiaokui.modules.quartz.repository.QuartzJobRepository;
import me.xiaokui.modules.quartz.repository.QuartzLogRepository;
import me.xiaokui.modules.quartz.service.QuartzJobService;
import me.xiaokui.modules.system.service.dto.JobQueryCriteria;
import me.xiaokui.modules.quartz.utils.QuartzManage;
...
public class QuartzJobServiceImpl implements QuartzJobService {
    ...
    public Object queryAll(JobQueryCriteria criteria, Pageable pageable){
        return me.xiaokui.utils.PageUtil.toPage(quartzJobRepository.findAll((root, criteriaQuery, criteriaBuilder) -> me.xiaokui.utils.QueryHelp.getPredicate(root,criteria,criteriaBuilder),pageable));
    }

    @Override
    public Object queryAllLog(JobQueryCriteria criteria, Pageable pageable){
        return me.xiaokui.utils.PageUtil.toPage(quartzLogRepository.findAll((root, criteriaQuery, criteriaBuilder) -> me.xiaokui.utils.QueryHelp.getPredicate(root,criteria,criteriaBuilder),pageable));
    }

    @Override
    public List<QuartzJob> queryAll(JobQueryCriteria criteria) {
        return quartzJobRepository.findAll((root, criteriaQuery, criteriaBuilder) -> me.xiaokui.utils.QueryHelp.getPredicate(root,criteria,criteriaBuilder));
    }

    @Override
    public List<QuartzLog> queryAllLog(JobQueryCriteria criteria) {
        return quartzLogRepository.findAll((root, criteriaQuery, criteriaBuilder) -> me.xiaokui.utils.QueryHelp.getPredicate(root,criteria,criteriaBuilder));
    }

    @Override
    public QuartzJob findById(Long id) {
        QuartzJob quartzJob = quartzJobRepository.findById(id).orElseGet(QuartzJob::new);
        me.xiaokui.utils.ValidationUtil.isNull(quartzJob.getId(),"QuartzJob","id",id);
        return quartzJob;
    }
    ...
    public void create(QuartzJob resources) {
        if (!CronExpression.isValidExpression(resources.getCronExpression())){
            throw new me.xiaokui.exception.BadRequestException("cron表达式格式错误");
        }
    ...
    public void update(QuartzJob resources) {
        ...
        if(me.xiaokui.utils.StringUtils.isNotBlank(resources.getSubTask())){
