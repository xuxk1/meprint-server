 ...
 */
package me.xiaokui.modules.quartz.rest;
...
public class QuartzJobController {
    ...
    @me.xiaokui.annotation.Log("新增定时任务")
    @ApiOperation("新增定时任务")
    @PostMapping
    ...
    @me.xiaokui.annotation.Log("修改定时任务")
    @ApiOperation("修改定时任务")
    @PutMapping
    ...
    @me.xiaokui.annotation.Log("更改定时任务状态")
    ...
    @me.xiaokui.annotation.Log("执行定时任务")
    @ApiOperation("执行定时任务")
