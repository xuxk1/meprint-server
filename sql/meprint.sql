...
-- ----------------------------
-- Table structure for case_backup
-- ----------------------------
...
CREATE TABLE `test_case` (
  ...
  `project_id` bigint(20) DEFAULT '0' COMMENT '对应项目id',
  PRIMARY KEY (`id`),
